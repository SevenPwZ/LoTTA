...
def get_dataloader(model_config: dict):
    ...
    if dataset_name in ['arrhythmia', 'breastw', 'cardio', 'glass', 'ionosphere', 'mammography', 'pima', 'satellite', 'satimage-2', 'thyroid', 'wbc','shuttle','musk','ecoli','vertebral','annthyroid']:
    ...
    elif dataset_name in ['wine', 'optdigits', 'pendigits', 'cardiotocography','fraud','census','WDBC','WPBC','yeast']:
