...
class CDTL(nn.Module):
    def __init__(self, model_config):
        ...
        for _ in range(self.en_nlayers-1):
            ...
            # encoder.append(LoRALinear(encoder_dim,self.hidden_dim,self.r,self.alpha))
        ...
        # encoder.append(LoRALinear(encoder_dim,self.z_dim,self.r,self.alpha))
        ...
        for _ in range(self.de_nlayers-1):
            ...
            # decoder.append(LoRALinear(decoder_dim,self.hidden_dim))
        ...
        # decoder.append(LoRALinear(decoder_dim,self.data_dim))
